...
if (isset($_POST['submit'])) {
  ...
  $sql = "UPDATE gh_customer_info SET password='$passhash' WHERE phone_number='$number'";
...
<body class="bg-light">
  ...
  color: lightgray;"></i>
                            ...
                            <div class="form-group d-flex flex-column" style="position: relative;">
                                <input type="password" class="form-control rounded-left" name="repass" placeholder="Re-type Password" required id="id_password1" style=" width: 100%;box-sizing: border-box;">
