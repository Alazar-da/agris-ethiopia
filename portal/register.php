...
function test_input($data) {
  ...
  if (!empty($name) && !empty($lname) && !empty($phone) && !empty($city) && !empty($pass)) {
    ...
    $sql="INSERT INTO `gh_customer_info`(`name`,`lname`,`email`, `address`, `Phone_number`, `password`, `level`) VALUES ('$name','$lname','$email','$city','$phone','$passhash','2')";
  }
  else {
    $sql="INSERT INTO `gh_customer_info`(`name`,`lname`, `email`, `address`, `Phone_number`, `password`, `level`) VALUES ('$name','$lname','','$city','$phone','$passhash','2')";
  }
  $_SESSION['sql']=$sql;
...
<body class="bg-light">
                    ...
                    <div class="login-wrap  px-4 pt-3 pb-0 mb-5 my-3 border" style="background-color: #00ACAB;">
                        ...
                        <form action="register.php" class="login-form" method="post">
                            ...
                            <div class="form-group d-flex flex-column" style="position: relative;">
                                <input type="password" class="form-control rounded-left" name="pass" placeholder="Password" required id="id_password" style=" width: 100%;box-sizing: border-box;">
  ...
  color: lightgray;"></i>
                            ...
                            <div class="form-group d-flex flex-column" style="position: relative;">
                                <input type="password" class="form-control rounded-left" name="repass" placeholder="Confrim Password" required id="id_password1" style=" width: 100%;box-sizing: border-box;">
