                    ...
                    <div class="login-wrap  px-4 pt-3 pb-0 mb-5 my-3 border" style="background-color: #00ACAB;">
                        ...
                        <form action="reset.php" class="login-form" method="post">
                           <div class="form-group d-flex flex-column">
                                <input type="password" class="form-control rounded-left" name="bpass" placeholder="Old password" required>
                                <label for="name" style="font-size: 14px; color:red;"><?php echo $bpassErr;?></label>
                            </div>
                            <div class="form-group d-flex flex-column">
                                <input type="password" class="form-control rounded-left" name="pass" placeholder="New Password" required>
                                <label for="name" style="font-size: 14px; color:red;"><?php echo $passErr;?></label>
                            </div>
                            <div class="form-group d-flex flex-column">
                                <input type="password" class="form-control rounded-left" name="repass" placeholder="Confrim Password" required>
